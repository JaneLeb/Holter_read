...
* PyQt6 / PySide6: Крутые инструменты для создания полнофункциональных приложений. Позволяют встраивать графики прямо в окно программы. PyQt6 мощнее, но сложнее в верстке интерфейса
